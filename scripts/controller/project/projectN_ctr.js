...
var projectN_ctr = myApp.controller('projectN_ctr', ['$scope', '$rootScope', '$log', '$timeout', '$http', '$location', 'MyProvider', 'publicFunc', 'ioniclocalStorage', '$ionicLoading','$filter', 
function($scope, $rootScope, $log, $timeout, $http, $location, MyProvider, publicFunc, ioniclocalStorage, $ionicLoading,$filter) {
    ...
    $scope.keywordsSearch = function () {
        if ($scope.keyword.searchInput == "" || $scope.keyword.searchInput == null) {
            ...
            var urls = MyProvider.domain +  "/api/Keyword/insertKeyword";
            var q = $http.post(
                    urls,
